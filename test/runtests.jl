...
@test isapprox(Statistics.mean(Interfacer.get_field(cs.model_sims.ice_sim, Val(:T_ice))), 270.0)
...
@test isapprox(Statistics.mean(T_I), cs.model_sims.ice_sim.params.T_I_ini)
