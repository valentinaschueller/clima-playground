...
cs, _ = coupled_heat_equations(iterations=10, a_i=0.5, Δt_min=10, t_max=1000, Δt_cpl=1000)
...
cs, _ = coupled_heat_equations(iterations=10, a_i=1.0, Δt_min=10, T_ice_ini=250.0, t_max=1000, Δt_cpl=1000)
...
@test isapprox(compute_ρ_analytical(p), 0.10729333488914307)