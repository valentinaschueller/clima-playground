    ...
    for t in ((tspan[begin]+Δt_cpl):Δt_cpl:tspan[end])
        ...
        if print_conv || plot_conv || return_conv
            ...
            if plot_conv
                ...
                scatter(k_atm, conv_fac_atm, label="atm", legend=:topright, color=:blue, markersize=5, xlabel="k", ylabel=title)#, ylim=(0, 0.0007), , ylim=(0, 0.0007)
...
function coupled_heat_equations()
    ...
    for a_i in a_is
        ...
        solve_coupler!(cs, true, true, false, false)
